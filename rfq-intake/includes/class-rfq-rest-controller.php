...
class RFQ_REST_Controller {
    ...
    public static function register_routes(): void {
        ...
        register_rest_route(
            self::NAMESPACE,
            '/sessions/(?P<session_id>[a-f0-9-]{36})/refresh',
            [
				'methods'             => WP_REST_Server::CREATABLE,
        ...
        register_rest_route(
            self::NAMESPACE,
            '/sessions/(?P<session_id>[a-f0-9-]{36})/contact',
            [
				'methods'             => 'PATCH',
        ...
        register_rest_route(
            self::NAMESPACE,
            '/sessions/(?P<session_id>[a-f0-9-]{36})/upload-urls',
            [
				'methods'             => WP_REST_Server::CREATABLE,
        ...
        register_rest_route(
            self::NAMESPACE,
            '/sessions/(?P<session_id>[a-f0-9-]{36})/draft',
            [
				'methods'             => 'PUT',
        ...
        register_rest_route(
            self::NAMESPACE,
            '/sessions/(?P<session_id>[a-f0-9-]{36})/submit',
            [
				'methods'             => WP_REST_Server::CREATABLE,
    ...
    private static function validate_upload_url_params( array $params ): array {
        ...
        } elseif ( in_array( $file_type, [ 'part', 'drawing' ], true ) ) {
